...
func TestBitvector512_BitAt(t *testing.T) {
	tests := []struct {
		...
		{
			bitlist: Bitvector512{0x01},
			idx:     0,
			want:    true,
		},
		{
			bitlist: Bitvector512{0x0E, 0xAA, 0x2F},
			idx:     1,
			want:    true,
		},
		{
			bitlist: Bitvector512{0x00, 0x00, 0x00, 0x00, 0x01, 0x23, 0xE2, 0xFE, 0xDD, 0xAC, 0xAD},
			idx:     87,
			want:    true,
		},
		{
		...
		{
			bitlist: Bitvector512{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0E},
			idx:     131,
			want:    true,
		},
		{
