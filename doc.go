...
//
// The key difference between a bitvector and a bitvector is how they track the
...
// Whereas the bitvector can be created with size N at runtime. The bitvector uses
// the most signficant bit in little endian order to indicate the start of the
// bitvector while in the byte representation.
package bitfield
